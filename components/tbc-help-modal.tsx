...
const SECTIONS: Section[] = [
  {
    ...
    body: (
      <>
        ...
        <p>ფილიალზე შესვლისას გვერდი 3 ნაწილად: <b>ობიექტის ინფო</b> (collapsed) → <b>დანადგარების ინვენტარი</b> → <b>კონტროლერები</b> → <b>ტრეკინგი</b> → <b>ხარჯთაღრიცხვა</b> → <b>შენიშვნები</b>.</p>
  ...
  },
  {
    id: 'chat',
    emoji: '📝',
    title: 'შენიშვნები — საერთო თრედი',
    body: (
      <>
        <p>ფილიალზე „<b>შენიშვნები</b>" ბარათი (desktop) და მობილურის „📝 შენიშვნები" ღილაკი ერთი და იგივე ბაზას იყენებენ — <b>desktop + mobile ერთმანეთს ხედავენ</b> real-time-ში.</p>
        <ul className="list-disc pl-5">
        ...
        <p>🗃 ღილაკი — confirm → 360-დღიანი არქივი (permanent delete არ ხდება). საკუთარს ყველას წაშლი; ადმინს ყველას.</p>
        <p>თუ ფილიალს ძველი „შენიშვნები" textarea-დან შენახული ტექსტი აქვს, ის თრედის ზევით 📌 ბანერად გამოჩნდება (read-only).</p>
      </>
    )
  },
  {

    ...
    <form onSubmit={submit} className="space-y-3">
      ...
      <div className="space-y-1">
        ...
        <div className="relative">
          <input
            ...
            className="w-full rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 pr-10 text-sm text-slate-900 focus:border-[#0071CE] focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#0071CE]/20"
            placeholder="••••••••"
            required
          />
          <button
            ...
            title={showPass ? 'დამალე პაროლი' : 'აჩვენე პაროლი'}
      ...
      <label className="flex cursor-pointer items-center gap-2 text-xs text-slate-600 select-none">
        <input
          ...
          className="h-3.5 w-3.5 cursor-pointer accent-[#0071CE]"
        />

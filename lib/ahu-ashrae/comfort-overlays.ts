...
export const COMFORT_OVERLAYS: ComfortOverlay[] = [
  {
    ...
    fill: 'rgba(15, 110, 58, 0.18)',
    border: 'rgba(15, 110, 58, 0.9)',
    vertices: [
      { tdb: 20, w: 4 },
      { tdb: 26, w: 4 },
      { tdb: 26, w: 12 },
  ...
  },
  {
    ...
    fill: 'rgba(124, 78, 192, 0.18)',
    border: 'rgba(124, 78, 192, 0.9)',
    vertices: [
      { tdb: 20, w: 3 },
      { tdb: 28, w: 3 },
      { tdb: 27, w: 12 },
  ...
  },
  {
    ...
    fill: 'rgba(220, 60, 30, 0.18)',
    border: 'rgba(220, 60, 30, 0.85)',
    vertices: [
      { tdb: 27, w: 8 },
      { tdb: 40, w: 8 },
      { tdb: 38, w: 25 },
